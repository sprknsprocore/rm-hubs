    ...
    globalAlerts: [
      {
        ...
        severity: 'high',
        type: 'Rental',
        message: '2 units idle >72 hrs on site. Rental leakage.',
        action: 'Request demobilization',
        financialRiskAmount: 1000,
        financialRiskLabel: 'Rental leak costing $1k/day',
      },
      {
        id: 'risk_002',
        severity: 'high',
    ...
    equipmentData: {
      telematics: [
        ...
        },
        {
          ...
          status: 'Idle',
          daysInactive: 5,
          location: { lat: 47.6100, lng: -122.3280 },
          health: 'Yellow',
          site: 'Site B',
        },
      ],
